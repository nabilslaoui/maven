FROM registry.gitlab.com/d837/java-headless/java-headless:master
...
RUN cd /usr/lib/jvm/java-11-openjdk-amd64/bin && \
   keytool -noprompt -import -alias certKubernetes -file /tmp/kubernetes.pem -keystore /usr/lib/jvm/java-11-openjdk-amd64/lib/security/cacerts --storepass changeit
